...
// Full catalog with SVG thumbnails, style selector, preview modal
// ============================================================

import * as React from 'react';
import { cn } from '@/lib/utils';
import { Loader2, Receipt, Mail, BarChart3, Scale, Shield, Eye } from 'lucide-react';
...
const CATEGORY_ORDER: {
  ...
  { key: 'comunicacion', label: 'Comunicación', emoji: '✉️', icon: Mail },
  { key: 'informe', label: 'Informes', emoji: '📊', icon: BarChart3 },
  { key: 'legal', label: 'Legal', emoji: '⚖️', icon: Scale },
  { key: 'ip', label: 'IP Específico', emoji: '🛡️', icon: Shield },
];
...
export default function TemplatesSettingsSection() {
  ...
  const [previewType, setPreviewType] = React.useState<DocumentType | null>(null);
  ...
  const handleModalStyleChange = (style: StyleKey) => {
    setLocalStyle(style as GlobalStyleId);
  };
  ...
  return (
    <div>
      ...
      <TemplatePreviewModal
        ...
        activeStyle={localStyle as StyleKey}
